...
//Sidebar Menu Handle
angular.module('app')
    .directive('memberFilter', ['$ajax', function($ajax) {
        return {
            restrict: 'AE',
            templateUrl: 'app/directives/member-filter/template.html',
            replace: true,
            scope: {
                onFilter: '&',
                memberCount: '='
            ...
            link: function (scope, el, attr) {
                ...
                scope.toggleMemberType = function(memberType) {
                    if(memberType !== scope.filterData.memberType) {
